package AimsProject.hust.soict.dsai.aims.cart.Cart;
...
public class Cart {
    ...
    private Store.DigitalVideoDisc itemsOrdered[] = new Store.DigitalVideoDisc[MAX_NUMBERS_ORDERED];
    private int qtyOrdered;
    private ArrayList<Store.DigitalVideoDisc> items;

    public int getQtyOrdered(){
        return qtyOrdered;
    }
    public void addDigitalVideoDisc(Store.DigitalVideoDisc disc) {
    ...
    public void removeDigitalVideoDisc(Store.DigitalVideoDisc disc) {
        if (qtyOrdered == 0){
    ...
    public void addItem(Store.DigitalVideoDisc dvd){
        this.items.add(dvd);
    }
    ...
    public void searchbyID(int id){
        for (Store.DigitalVideoDisc dvd: items){
            if (dvd.getId() == id){
